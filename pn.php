...
<body class="light-mode" onload="toggleMode()"> <!--Início do corpo HTMl-->
    <header>
        ...
        <button id="btn1" style="width: 25px; height: 35px; border-radius: 100%;"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="-200" fill="GreenColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2"/>
</svg></button> <!--botão para janela de atalhos-->
       <!-- <button id="btn2" style="width: 16px; height: 16px; border-radius: 100%;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="GreenColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2"/>
</svg></button> --> <!--botão para janela de atalhos-->
    ...
    <div>
        <h2>Essa página está em manutenção! <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wrench" viewBox="0 0 16 16">
  <path d="M.102 2.223A3.004 3.004 0 0 0 3.78 5.897l6.341 6.252A3.003 3.003 0 0 0 13 16a3 3 0 1 0-.851-5.878L5.897 3.781A3.004 3.004 0 0 0 2.223.1l2.141 2.142L4 4l-1.757.364zm13.37 9.019.528.026.287.445.445.287.026.529L15 13l-.242.471-.026.529-.445.287-.287.445-.529.026L13 15l-.471-.242-.529-.026-.287-.445-.445-.287-.026-.529L11 13l.242-.471.026-.529.445-.287.287-.445.529-.026L13 11z"/>
</svg></h2>
       <!--<h2>Faça login para acessar os conteúdos <a href="acessorestrito.php" title="Acesso Alfa">Login</a></h2> -->
       <h2>Faça login como administrador para acessar os conteúdos <a href="loginadm.php" title="Logar como Administrador" ">Login</a></h2>
...
<!-- <a href="p2.html" style="color: blue;">&rarr;</a>  ir para segunda página-->  <!--ATIVAR QUANDO NECESSÁRIO!
  ...
  <!--      <script src="js/index.js"></script>      
    ...
    <script>
        ...
        $("#btn2").click(function(){
        $("#conteudo999").load("divConteudo0101.php")
